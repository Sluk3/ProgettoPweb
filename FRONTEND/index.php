    ...
    <div data-bs-spy="scroll" data-bs-target="#navbar">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption d-block">
                                ...
                                <a href="./products.php" class="btn btn-primary btn-lg" data-aos="zoom-in">Shop Now</a>
                            </div>
                        </div>
        ...
        <section id="aboutus" class=" bg-black text-light ">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src="../IMG/Immagine WhatsApp 2024-11-01 ore 19.35.54_0990ef6f.png" class="img-fluid rounded" alt="Team SLUKE">
                    </div>
                    <div class="col-md-6">
                        <h2>Our Story</h2>
